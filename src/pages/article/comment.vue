    ...
    <div class='comment-create-box fxt'>
      ...
      <div class='editor-wrap'>
        ...
        <div class='actions fx-b'>
          ...
          <el-button type='primary' :disabled='form.content.length == 0' :loading='loading' @click='() => toCreate()'>
            发表评论
          </el-button>
        </div>
      </div>
...
const toCreate = (data = {}) => {
  ...
  loading.value = true
  // 当前用户是createdBy
  form_data.createdBy = user_info?.id
...
onMounted(() => {
  form.value = {
    sourceId: props.art_id, // 文章id
    sourceType: 1, // 文章或者沸点
    type: 'source',
    content: '',
    targetUser: props.user_id  // 文章作者id
  }
  getComments()
})
</script>
